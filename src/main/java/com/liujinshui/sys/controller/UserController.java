...
import com.liujinshui.sys.vo.LoginUserVo;
...
public class UserController {
     ...
     */
    @PostMapping("/login")
    public JSONResult login(String loginname, String loginpwd, HttpServletRequest httpServletRequest){
        //获取当前登录主体对象
        ...
        try {
            ...
            //保存session
            httpServletRequest.getSession().setAttribute(SystemConstant.LOGINUSER,userVo.getUser());
